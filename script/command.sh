...
CUDA_VISIBLE_DEVICES=0 bash script/main_segmentation.sh cfgs/s3dis/pointmetabase-l.yaml wandb.use_wandb=False mode=test --pretrained_path log/for_s3dis_upload_area5_best/s3dis-train-pointmetabase-l-ngpus1-seed4333-20221107-205749-LoivDYbY7pVF6pJtNKokEU/checkpoint/s3dis-train-pointmetabase-l-ngpus1-seed4333-20221107-205749-LoivDYbY7pVF6pJtNKokEU_ckpt_best.pth
CUDA_VISIBLE_DEVICES=1 bash script/main_segmentation.sh cfgs/s3dis/pointmetabase-xl.yaml wandb.use_wandb=False mode=test --pretrained_path log/for_s3dis_upload_area5_best/s3dis-train-pointmetabase-xl-ngpus1-seed2425-20221107-095339-3Ebwo3FGeyLhVKzTjgM8EK/checkpoint/s3dis-train-pointmetabase-xl-ngpus1-seed2425-20221107-095339-3Ebwo3FGeyLhVKzTjgM8EK_ckpt_best.pth
CUDA_VISIBLE_DEVICES=0 bash script/main_segmentation.sh cfgs/s3dis/pointmetabase-xxl.yaml wandb.use_wandb=False mode=test --pretrained_path log/for_s3dis_upload_area5_best/s3dis-train-pointmetabase-xxl-ngpus1-seed1111-20221108-092238-kkyyxcTLq7MLLkumjivREZ/checkpoint/s3dis-train-pointmetabase-xxl-ngpus1-seed1111-20221108-092238-kkyyxcTLq7MLLkumjivREZ_ckpt_best.pth
